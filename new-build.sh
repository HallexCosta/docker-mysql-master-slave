...
# source ./infra/config/variables.sh
source ./infra/utils/clear-volumes.sh
...
source ./infra/utils/functions.sh
source ./infra/mysql-master.sh
...
source ./infra/mysql-slave-01.sh
# source ./infra/mysql-slave-02.sh
